            ...
            <div class="row g-3">
               <div class="col-auto">
                  <div class="search-box">
                     <form action="{{ url('searchbusiness') }}" class="position-relative" data-bs-toggle="search" data-bs-display="static"><input class="form-control search-input search" type="search"   name="query" placeholder="Search by business name" aria-label="Search" />
           ...
           <div class="card">
             <div class="card-header">
               <div class="card-tools">
                  <form action="{!! route('page.searchbusiness') !!}" method="GET">
                ...
                <tbody>
                  @foreach ($businesses as $business)
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                           ...
                           <div class="position-relative">
                              <div class="hover-actions">
                                 <a class="btn btn-sm btn-phoenix-secondary me-1 fs--2" href="{!! route('page.business.details',$business->business_code) !!}">
                                    <button class="btn btn-primary"> <i class="nav-icon fas fa-eye"></i>View</button></a></a>
                              </div>
                           </div>
                           </td>
                        </tr>
