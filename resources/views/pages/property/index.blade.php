           ...
           <div class="card">
             ...
             <div class="card-body table-responsive p-0">
               <table class="table table-hover text-nowrap">
                 <thead>
                   <tr>
                     <th><div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" /></div></th>
                     <th></th>
                     <th>Property</th>
                     <th>Price</th>
                     <th>Location</th>
                 ...
                 <tbody>
                  @foreach ($properties as $property)
                   <tr>
                     <td><div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" /></div></td>
                     <td>  <div class="border rounded-2">
                        @if($property->image)
                     ...
                     <td><a href="{!! route('property.edit',$property->property_code) !!}">{!! $property->title !!}</a></td>
                     <td><span class="tag tag-success">£{!! $property->price !!}</span></td>
                  ...
                  <td><a href="{!! route('property.edit',$property->property_code) !!}"> <button class="btn btn-primary"> <i class="nav-icon fas fa-edit"></i>Edit</button></a></td>
