...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{!! asset('asset2/plugins/fontawesome-free/css/all.min.css') !!}">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css') !!}">
  <!-- Tempusdominus Bootstrap 4 -->
  <link rel="stylesheet" href="{!! asset('asset2/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') !!}">
  <!-- iCheck -->
  <link rel="stylesheet" href="{!! asset('asset2/plugins/icheck-bootstrap/icheck-bootstrap.min.css') !!}">
  <!-- JQVMap -->
  <link rel="stylesheet" href="{!! asset('asset2/plugins/jqvmap/jqvmap.min.css') !!}">
  <!-- Theme style -->
  <link rel="stylesheet" href="{!! asset('asset2/dist/css/adminlte.min.css') !!}">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{!! asset('asset2/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') !!}">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{!! asset('asset2/plugins/daterangepicker/daterangepicker.css') !!}">
  <!-- summernote -->
  <link rel="stylesheet" href="{!! asset('asset2/plugins/summernote/summernote-bs4.min.css') !!}">
</head>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="https://baroncabot.com" class="brand-link">
      <img src="{!! asset('asset2/dist/img/download.png"') !!} alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{!! asset('asset2/dist/img/user2-160x160.jpg') !!}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Reserved Unit Details</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
   ...
   <div class="mb-9">
      ...
      <div class="row">
         <div class="col-md-3">
            ...
            <div class="col-12  col-xxl-12 mb-xxl-3 mt-3">
               <div class="card h-100">
                  <div class="card-body pb-3">
                     <div class="d-flex align-items-center mb-3">
                        <h3 class="me-1">Agency Details</h3>
                     </div>
...
<!-- jQuery UI 1.11.4 -->
<script src="{!! asset('asset2/plugins/jquery-ui/jquery-ui.min.js') !!}"></script>

<!-- Bootstrap 4 -->
<script src="{!! asset('asset2/plugins/bootstrap/js/bootstrap.bundle.min.js') !!}"></script>
<!-- ChartJS -->
<script src="{!! asset('asset2/plugins/chart.js/Chart.min.js') !!}"></script>
<!-- Sparkline -->
<script src="{!! asset('asset2/plugins/sparklines/sparkline.js') !!}"></script>
<!-- JQVMap -->
<script src="{!! asset('asset2/plugins/jqvmap/jquery.vmap.min.js') !!}"></script>
<script src="{!! asset('asset2/plugins/jqvmap/maps/jquery.vmap.usa.js') !!}"></script>
<!-- jQuery Knob Chart -->
<script src="{!! asset('asset2/plugins/jquery-knob/jquery.knob.min.js') !!}"></script>
<!-- daterangepicker -->
<script src="{!! asset('asset2/plugins/moment/moment.min.js') !!}"></script>
<script src="{!! asset('asset2/plugins/daterangepicker/daterangepicker.js') !!}"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="{!! asset('asset2/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') !!}
<script src="asset2/plugins/summernote/summernote-bs4.min.js') !!}"></script>
<!-- overlayScrollbars -->
<script src="{!! asset('asset2/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js') !!}"></script>
<!-- AdminLTE App -->
<script src="{!! asset('asset2/dist/js/adminlte.js') !!}"></script>

<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{!! asset('asset2/dist/js/pages/dashboard.js') !!}"></script>
</body>
</html>
