             ...
             <div class="card-body table-responsive p-0">
               <table class="table table-hover text-nowrap">
                 <thead>
                  ...
                  <th>Price</th>
                  <th>Signature</th>
                  <th>Proof_Payement</th>
                 </thead>
                 <tbody>
                  @foreach($retrieve as $rt)
                  <tr>
                     <td>{{$rt->PropertyName}}</td>
                     <td>{{$rt->agent_name}}</td>
                     <td>{{$rt->BuyersName}}</td>
                     <td>{{$rt->phone_number}}</td>
                     <td>{{$rt->unit_price}}</td>
                     <td><img src="{{ $rt->signature }}" alt="Signature Image" style="width: 50px; height:50px;"/></td>
                     <td><a href="{{ route('download', ['id' => $rt->id]) }}">Download</a></td>
                  @endforeach
                 </tbody>
               </table>
             </div>
