      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
                 <a href="{!! route('reservations.index') !!}" class="nav-link active">
                   <i class="far fa-circle nav-icon"></i>
                   <p>Client Form</p>
                 </a>
               </li>
...
<!-- Tempusdominus Bootstrap 4 -->
<script src="{!! asset('asset2/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') !!}"></script>
<!-- Summernote -->
<script src="{!! asset('asset2/plugins/summernote/summernote-bs4.min.js') !!}"></script>
<!-- overlayScrollbars -->
